...
#region 公有函数
    ...
    //四舍五入接口
    public static int FloatToFourInt(float n)
    {
        int result;
        int a = (int)(n * 10);
        a = a % 10;
...
#if UNITY_IPHONE
        if (Screen.width == 2436 && Screen.height == 1125 || Screen.width == 2688 && Screen.height == 1242 || Screen.width == 1792 && Screen.height == 828)
    ...
    public static string ListToString<T>(List<T> list)
    {
        ...
        catch (System.Exception ex)
        {
            ...
            Debug.LogError("PublicFunction-" + st.GetFrame(0).ToString() + "- error = " + ex.ToString());
        }
        return str;
    }
    ...
    /// </summary>
    public static string[] colorAry = new string[] { "#FF0000", "#FF8000", "#FFFF00", "#00FF00", "#00FFFF", "#0000FF", "#800080", "#FFFFFF", "#000000", "#808080"};
    public static string ConverRgtToColor(byte r, byte g, byte b, bool collectFlag = true)
    {
        ...
        if (hsv[1] >= 30 && hsv[2] >= 60 && (hsv[1] + hsv[2] >= 200 || hsv[1] >= 80 && hsv[2] >= 80 && hsv[0] >= 260 && hsv[0] <= 320))//260-320紫色放大区域
        {
            ...
            {//黄色
                if (b <= 140 || r >= 240 && g >= 240 && b <= 180 || r >= 254 && g >= 254 && b <= 220)
                {
                    color = colorAry[2];
                }
            }
