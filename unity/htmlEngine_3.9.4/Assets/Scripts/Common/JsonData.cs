	...
	public class JsonData
	{
		...
		public JsonData this [string key] {
			...
			get {
                ...
                if (null != m_value)
                {
                    Debug.LogWarning("Error! Type = " + m_value.GetType().Name);
                }
		...
		public static explicit operator String (JsonData data)
		{
			...
			Debug.LogWarning ("Not Containing a String");
			return "";
		}
		...
		public static explicit operator Int32 (JsonData data)
		{
			...
			Debug.LogWarning ("Not Containing a Int32");
			return output;
		}
		...
		public static explicit operator Int64 (JsonData data)
		{
			...
			Debug.LogWarning ("Not Containing a Int64");
			return output;
		}
		...
		public static explicit operator Boolean (JsonData data)
		{
			...
			Debug.LogWarning ("Not Containing a Boolean");
			return output;
		}
		...
		public static explicit operator Double (JsonData data)
		{
			...
			Debug.LogWarning ("Not Containing a Double");
			return output;
		}
