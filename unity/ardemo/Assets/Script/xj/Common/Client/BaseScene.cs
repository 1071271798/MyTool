...
public abstract class BaseScene
{
    ...
    {
        Game.Platform.PlatformMgr.Instance.Log(Game.Platform.MyLogType.LogTypeDebug, "Open Scene = " + this.GetType().ToString());
        if (isOpen)
        {
            return;
        }
    ...
    {
        Game.Platform.PlatformMgr.Instance.Log(Game.Platform.MyLogType.LogTypeDebug, "Close Scene = " + this.GetType().ToString());
        if (!isOpen)
        {
            return;
        }
