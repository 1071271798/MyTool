...
public class UIInputEditor : UIWidgetContainerEditor
{
	public override void OnInspectorGUI ()
	{
		...
		EditorGUI.BeginDisabledGroup(label == null || label.objectReferenceValue == null);
		{
            ...
            NGUIEditorTools.DrawPaddedProperty("Open FloatingLabel", serializedObject, "openFloatLabel");
            NGUIEditorTools.DrawProperty("FloatingLabel Color", serializedObject, "mFloatingColor");
            NGUIEditorTools.DrawProperty("DisFloatingColor Color", serializedObject, "mDisFloatingColor");
            NGUIEditorTools.DrawProperty("FloatingLabel Offset", serializedObject, "mFloatOffset");
