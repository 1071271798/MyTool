...
public class UIButtonColor : UIWidgetContainer
{
	...
	public Color hover = new Color(238f / 255f, 238f / 255f, 238f / 255f, 1f);

	/// <summary>
	/// Color to apply on the pressed event.
	/// </summary>

	public Color pressed = new Color(238f / 255f, 238f / 255f, 238f / 255f, 0.8f);

	/// <summary>
	/// Color that will be applied when the button is disabled.
	/// </summary>

	public Color disabledColor = new Color(1, 1, 1, 0.6f);
